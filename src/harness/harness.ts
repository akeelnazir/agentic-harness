...
You can use multiple tools if needed to answer the question thoroughly.`;
    ...
    while (iterations < maxIterations) {
      ...
      try {
        console.log(`[LLMSTUDIO REQUEST] Sending prompt to model...`);
        ...
        console.log(`[LLMSTUDIO RESPONSE] Received ${assistantResponse.length} characters`);
        ...
        console.error('Error generating response from LLMStudio:', error);
